...
import com.liu.springboot04web.mapper.Kn01B002SubMapper;
...
@Repository
public class Kn01B002SubDao implements InterfaceKnPianoDao {

    @Autowired
    private Kn01B002SubMapper knSub001Mapper;
    ...
    // 获取所有符合查询条件的科目信息
    public List<Kn01B002SubBean> searchSubjects(Map<String, Object> params) {
    ...
    // 保存科目信息（新建或更新）
    public void save(Kn01B002SubBean knSub001Bean) {
