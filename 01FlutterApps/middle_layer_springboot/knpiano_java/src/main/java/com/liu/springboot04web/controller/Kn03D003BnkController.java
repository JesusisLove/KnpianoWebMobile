...
@Controller
public class Kn03D003BnkController {
    ...
    public String search(@RequestParam Map<String, Object> queryParams, Model model) {
        ...
        Collection<Kn03D003BnkBean> searchResults = knBnk001Dao.searchBanks(conditions);
    ...
    public String executeBankAdd(Model model, Kn03D003BnkBean knBnk001Bean) {
        // 画面数据有效性校验
    ...
    public String toBankEdit(@PathVariable("id") String id, Model model) {
        Kn03D003BnkBean knBnk001Bean = knBnk001Dao.getInfoById(id);
    ...
    public String executeBankEdit(Model model, Kn03D003BnkBean knBnk001Bean) {
        // 画面数据有效性校验
        if (validateHasError(model, knBnk001Bean)) {
            return "kn_bnk_001/knbnk001_add_update";
        } 
    ...
    private boolean validateHasError(Model model, Kn03D003BnkBean knStu001Bean) {
    ...
    private boolean inputDataHasError(Kn03D003BnkBean knStu001Bean, List<String> msgList) {
