...
@Controller
public class Kn01L001SubController {
    ...
    public String search(@RequestParam Map<String, Object> queryParams, Model model) {
        ...
        Collection<Kn01L001SubBean> searchResults = knSub001Dao.searchSubjects(conditions);
    ...
    public String executeSubjectAdd(Kn01L001SubBean knSub001Bean) {
    ...
    public String toSubjectEdit(@PathVariable("id") String id, Model model) {
        Kn01L001SubBean knSub001Bean = knSub001Dao.getInfoById(id);
    ...
    public String executeSubjectEdit(Kn01L001SubBean knSub001Bean) {
