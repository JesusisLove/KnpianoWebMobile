...
@RestController
public class Kn05S003SubEdaController4Mobile {
    ...
    public ResponseEntity<Collection<Kn05S003SubjectEdabnBean>> getSubdentList(@PathVariable("subId") String subId) {
        // 获取目前所有科目信息显示在画面一览上
        Collection<Kn05S003SubjectEdabnBean> collection = kn05S003SubjectEdabnDao.getSubEdaList(subId);
    ...
    public void excuteInfoAdd(@RequestBody Kn05S003SubjectEdabnBean knSub001Bean) {
