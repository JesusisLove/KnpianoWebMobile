...
class _StudentDocumentEditPageState extends State<StudentDocumentEditPage> {
  ...
  Future<void> fetchStudentInfo() async {
    final String apiStuDocUrl = '${KnConfig.apiBaseUrl}${Constants.stuDocInfoEdit}/${widget.stuId}/${widget.subjectId}/${widget.subjectSubId}/${widget.adjustedDate}';
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        standardPrice = studentInfo['standardPrice'] ?? 0.0;
      });
    } else {
